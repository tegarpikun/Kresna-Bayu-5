...
//
// 6 foto TERBARU (id 9-14) ditambahkan menyusul urutan Z yang sudah ada -
// CAMERA_END_Z di CameraRig.js juga sudah disesuaikan (-38 -> -63) supaya
// kamera benar-benar menembus sampai foto paling akhir yang baru ini.
// =====================================================================
export const galleryPhotos = [
  {
    id: 1,
    url: '/photos/gwk-bali.jpg',
  ...
  {
    id: 3,
    url: '/photos/de-djawatan-banyuwangi.jpg',
    title: 'Rimba Fajar',
  ...
  },
  {
    ...
    position: [-3.2, 1.0, -37.6],
    rotation: [0, 0.1, 0.03],
  },
  {
    id: 10,
    url: '/photos/katedral-jakarta.jpg',
    title: 'Katedral Jakarta',
    location: 'Jakarta Pusat',
    position: [3.0, -0.8, -41.8],
    rotation: [0, -0.13, -0.04],
  },
  {
    id: 11,
    url: '/photos/pantai-matahari-terbit.jpg',
    title: 'Pantai Matahari Terbit',
    location: 'Banyuwangi',
    position: [-2.8, 1.4, -46.0],
    rotation: [0, 0.15, 0.05],
  },
  {
    id: 12,
    url: '/photos/goa-maria-air-sanih.jpg',
    title: 'Goa Maria Air Sanih',
    location: 'Bali Utara',
    position: [3.4, -1.1, -50.2],
    rotation: [0, -0.1, -0.03],
  },
  {
    id: 13,
    ...
    location: 'Bali',
    position: [-3.0, 0.6, -54.4],
    rotation: [0, 0.08, 0.04],
  },
  {
    id: 14,
    url: '/photos/yubellium.jpg',
    title: 'Hutan De Djawatan',
    location: 'Banyuwangi',
    position: [2.6, -1.5, -58.6],
...
export const destinationPhotos = [
  ...
  {
    id: 'd5',
    url: '/photos/destinations/malang.jpg',
    title: 'Malang',
    location: 'BNS',
  },
  {
    id: 'd6',
    url: '/photos/destinations/antasena-tunnel.jpg',
    title: 'Jakarta',
    location: 'Sea World',
  },
  {
    id: 'd7',
    url: '/photos/destinations/lawangsewu.jpg',
    title: 'semarang',
    location: 'Lawang Sewu',
  },
  {
    id: 'd8',
    url: '/photos/destinations/banjar.jpg',
    title: 'Banjarmasin',
    location: 'Pasar Apung',
  },
];
