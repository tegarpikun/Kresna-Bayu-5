...
export const ziarahDestinations = [
  {
    ...
    metaDescription:
      'Paket tour rohani ziarah Maria ke Gua Maria Lourdes Puhsarang Kediri dari Seluruh Indonesia. Transportasi rombongan, itinerary fleksibel, cocok untuk komunitas paroki atau keluarga.',
    heroImage: '/photos/ziarah/dokumentasi/puhsarang.jpg',
    intro:
    ...
    highlights: [
      ...
      'Akses relatif dekat dari Pusat Kota',
    ],
    ...
    faq: [
      {
        ...
        a: 'Perjalanan darat dari Surabaya/malang ke Puhsarang biasanya hanya memakan waktu sekitar 2-3 jam tergantung kondisi lalu lintas, sehingga bisa dijalankan sebagai ziarah sehari.',
      },
      {
  ...
  },
  {
    ...
    metaTitle: 'Paket Ziarah Maria Sendangsono Yogyakarta dari seluruh Indonesia | Kresna Bayu Tour',
    metaDescription:
      'Paket tour rohani ziarah Maria ke Gua Maria Sendangsono, Kulon Progo Yogyakarta. Transportasi rombongan, pendampingan, cocok untuk komunitas paroki.',
    heroImage: '/photos/ziarah/dokumentasi/sendangsono.jpg',
    intro:
  ...
  },
  {
    ...
    metaTitle: 'Paket Ziarah Ganjuran Yogyakarta dari seluruh Indonesia | Kresna Bayu Tour',
    metaDescription:
      'Paket tour rohani ziarah ke Gereja Hati Kudus Tuhan Yesus Ganjuran, Bantul Yogyakarta. Cocok untuk rombongan komunitas paroki dan keluarga.',
    heroImage: '/photos/ziarah/dokumentasi/ganjuran.jpg',
    intro:
    ...
    faq: [
      {
        q: 'Apakah Gereja Ganjuran bisa dikunjungi sebagai bagian dari tour wisata lain?',
        a: 'Ganjuran biasanya digabung dengan destinasi ziarah Yogyakarta lain seperti Sendangsono dalam paket 2 hari 1 malam.',
      },
    ],
  },
  ...
  // =============================================================
  {
    ...
    heroImage: '/photos/ziarah/dokumentasi/pasionis.jpg',
    intro:
  ...
  },
  {
    ...
    heroImage: '/photos/ziarah/dokumentasi/ngadireso.jpg',
    intro:
  ...
  {
    slug: 'columbarium-malang',
    name: 'Columbarium Malang',
    metaTitle: 'Kunjungan Rohani Columbarium Malang | Kresna Bayu Tour',
    metaDescription:
      'Layanan tour rohani kunjungan ke Columbarium Katolik di Malang untuk mendoakan keluarga yang telah berpulang. Transportasi rombongan lingkungan/paroki dari Kresna Bayu Tour.',
    heroImage: '/photos/ziarah/dokumentasi/columbarium.jpg',
    intro:
      'Columbarium adalah tempat penyimpanan abu jenazah hasil kremasi yang dikelola komunitas Katolik di Malang, menjadi tujuan kunjungan umat yang ingin mendoakan keluarga atau kerabat yang telah berpulang. Suasananya tenang dan tertata, cocok untuk kunjungan doa pribadi maupun rombongan lingkungan/paroki.',
    highlights: [
      'Tempat tenang untuk mendoakan keluarga yang telah berpulang',
      'Kerap dikunjungi rombongan lingkungan/paroki, terutama menjelang masa Novena Arwah di awal November',
      'Cocok digabung dengan agenda ziarah singkat lain di dalam atau sekitar Kota Malang',
      'Suasana yang tertata rapi dan teduh untuk doa bersama',
    ],
    idealFor:
      'Keluarga yang ingin mendoakan anggota keluarga yang telah berpulang, komunitas lingkungan/paroki yang mengadakan doa arwah bersama',
    faq: [
      {
        q: 'Kapan waktu yang tepat untuk berkunjung ke Columbarium?',
        a: 'Banyak keluarga dan komunitas memilih berkunjung menjelang atau selama bulan November (masa Novena Arwah) sebagai bagian dari tradisi mendoakan arwah, meski kunjungan pribadi bisa dilakukan sesuai jadwal yang berlaku.',
      },
      {
        q: 'Apakah kunjungan ke Columbarium bisa digabung dengan agenda rombongan lain di Malang?',
        a: 'Bisa. Kunjungan ke Columbarium biasanya singkat sehingga mudah digabung dengan agenda ziarah atau kegiatan rohani lain di dalam Kota Malang.',
      },
    ],
  },
  ...
  },
  {
    ...
    metaTitle: 'Paket Ziarah Gua Maria Tritis Gunungkidul dari seluruh Indonesia | Kresna Bayu Tour',
    metaDescription:
